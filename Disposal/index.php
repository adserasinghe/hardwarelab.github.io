		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
				    <h4 class="page-title">Disposal</h4>
					<ol class="breadcrumb">
					  <li class="breadcrumb-item"><a href="../Home Page/index1.html">Home</a></li>
					  <li class="breadcrumb-item active" aria-curent="page">Disposal</li>
					</ol>
				 </div>
			 </div>
		  </div>
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Manage Disposal Iteam </h2>
							 </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
		    <label>Name</label>
			<input type="text"form-control" required></textarea>
		</div>
		<div class="form-group">
		    <label>ID</label>
			<input type="text" class="form-control" required>
